				...
				{{% _.each(items, function(item) { %}}
					<div class="so-directory-item">
						<div class="so-directory-item-wrapper">
							<div class="so-screenshot" data-src="https://s.wordpress.com/mshots/v1/{{% print( encodeURIComponent(item.preview) ) %}}?w=400">
...
<script type="text/template" id="siteorigin-panels-dialog-prebuilt-entry">
	...
	<div class="so-directory-item layout">
		<div class="so-directory-item-wrapper">
			<div class="so-screenshot">
				<img src="<?php echo get_template_directory_uri(); ?>/prebuilt-layouts/{{%= lid %}}.jpg" style="display: block;">
			</div>

			<div class="so-bottom">
				<h4 class="so-title">{{%= name %}}</h4>
